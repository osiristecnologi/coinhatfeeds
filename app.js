...
/* ═══════════════════════════════════════
   I18N - COMPLETO COM TODOS IDIOMAS
═══════════════════════════════════════ */
const i18n = {
  ...
  es: {
    ...
    memecoins_sub: 'Precios y gráficos en tiempo real',
    vol: 'Vol 24h',
    liq: 'Liquidez',
    mc: 'Cap. Mercado',
    contract: 'Contrato',
    chart_btn: 'Ver gráfico avanzado',
    loading: 'Cargando...',
    no_data: 'Sin datos',
    live: 'VIVO',
    no_links: 'Sin enlaces',
    bot_hello: '¡Hola! Soy CryptoBot 🤖',
    bot_default: 'No entendí.',
    buy: 'Comprar'
  },
  ...
  zh: {
    ...
    swap: '交换',
    refresh: '刷新',
    memecoins_title: '热门模因币',
    memecoins_sub: '实时价格和图表',
    vol: '24h交易量',
    liq: '流动性',
    mc: '市值',
    contract: '合约',
  ...
  ja: {
    ...
    swap: 'スワップ',
    refresh: '更新',
    memecoins_title: 'トレンドミームコイン',
    memecoins_sub: 'リアルタイム価格とチャート',
    vol: '24時間出来高',
    liq: '流動性',
    mc: '時価総額',
    contract: 'コントラクト',
    ...
    no_data: 'データが見つかりません',
    live: 'ライブ',
    no_links: 'リンクが見つかりません',
    bot_hello: 'こんにちは！CryptoBotです 🤖',
    bot_default: '理解できませんでした。',
    buy: '購入'
  },
  ...
  ru: {
    ...
    swap: 'Обмен',
    refresh: 'Обновить',
    memecoins_title: 'Популярные мемкоины',
    memecoins_sub: 'Цены и графики в реальном времени',
    vol: 'Объем 24ч',
    liq: 'Ликвидность',
    mc: 'Капитализация',
    contract: 'Контракт',
    chart_btn: 'Открыть график',
    loading: 'Загрузка...',
    no_data: 'Данные не найдены',
    live: 'В ЭФИРЕ',
    no_links: 'Ссылки не найдены',
    bot_hello: 'Привет! Я CryptoBot 🤖',
    bot_default: 'Я не понял.',
    buy: 'Купить'
  }
...
function updateInterfaceLang() {
  ...
  // Recarrega os cards pra traduzir o botão "Comprar"
  if (state.memeData.length > 0) {
...
// Função auxiliar pra decodificar o JSON do onclick
...
function renderSearch(pairs) {
  ...
  container.innerHTML =
    pairs.slice(0, 8).map(p => {
      ...
      return `
      <div class="sr-item"
        onclick='openTokenFromData("${pairData}");closeResults()'>
